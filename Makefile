...
gcif_objects += SystemInfo.o ImageWriter.o SmallPalette.o
...
SRCS += encoder/FilterScorer.cpp encoder/SmallPalette.cpp
...
SmallPalette.o : encoder/SmallPalette.cpp
	$(CCPP) $(CPFLAGS) -c encoder/SmallPalette.cpp
